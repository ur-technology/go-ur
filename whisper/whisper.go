...
import (
	...
	"github.com/ur/go-ur/event/filter"
...
// Whisper represents a dark communication interface through the UR
...
type Whisper struct {
	...
	expirations map[uint32]*set.SetNonTS  // Message expiration pool (TODO: somuring lighter)
...
// New creates a Whisper client ready to communicate through the UR P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
