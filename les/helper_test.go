...
import (
	...
	"github.com/ur-technology/go-ur/les/flowcontrol"
	"github.com/ur-technology/go-ur/light"
...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen)) (*ProtocolManager, ethdb.Database, *LesOdr, error) {
	...
	if lightSync {
		...
		gchain, _ := core.GenerateChain(chainConfig, blockchain, genesis, db, blocks, generator)
