...
func GenerateChain(parent *types.Block, db urdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
...
// header only chain.
func newCanonical(n int, full bool) (urdb.Database, *BlockChain, error) {
...
func makeHeaderChain(parent *types.Header, n int, db urdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, db urdb.Database, seed int) []*types.Block {
