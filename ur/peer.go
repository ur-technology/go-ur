...
// PeerInfo represents a short summary of the UR sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // UR protocol version negotiated
...
// Handshake executes the ur protocol handshake, negotiating version number,
