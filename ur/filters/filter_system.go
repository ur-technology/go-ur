...
// package filters implements an ur filtering system for block,
...
// for specific LOG events fired by the EVM (UR Virtual Machine).
...
// filterLoop waits for specific events from ur and fires their handlers
