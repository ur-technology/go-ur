...
//
// Detailed usage document and tutorial available on the go-ur Wiki page:
// https://github.com/ur-technology/go-ur/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
