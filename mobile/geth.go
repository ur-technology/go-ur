...
import (
	...
	"github.com/ur-technology/go-ur/ethclient"
...
// NodeConfig represents the collection of configuration values to fine tune the Gur
// node embedded into a mobile process. The available values are a subset of the
// entire API provided by go-ur to reduce the maintenance surface and dev
// complexity.
...
// Node represents a Gur Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Gur node.
