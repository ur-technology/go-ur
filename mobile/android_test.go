...
public class AndroidTest extends InstrumentationTestCase {
	...
	public void testAccountManagement() {
		try {
			AccountManager am = new AccountManager(getInstrumentation().getContext().getFilesDir() + "/keystore", Gur.LightScryptN, Gur.LightScryptP);
...
func TestAndroid(t *testing.T) {
	...
	// Generate the mobile bindings for Gur and add the tester class
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/ur-technology/go-ur/mobile")
