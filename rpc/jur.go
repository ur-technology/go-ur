...
func NewJur(urApi shared.URApi, re *jsre.JSRE, client comms.URClient, fe xur.Frontend) *Jur {
	return &Jur{urApi, re, client, fe}
}

func (self *Jur) err(call otto.FunctionCall, code int, msg string, id interface{}) (response otto.Value) {
...
func (self *Jur) Send(call otto.FunctionCall) (response otto.Value) {
...
// the user response back to the gur service
func (self *Jur) handleRequest(req *shared.Request) bool {
	var err error
	var args []interface{}
...
func (self *Jur) askPassword(id interface{}, jsonrpc string, args []interface{}) bool {
	var err error
	var passwd string
	if len(args) >= 1 {
...
func (self *Jur) confirmTransaction(id interface{}, jsonrpc string, args []interface{}) bool {
