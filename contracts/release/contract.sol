...
// versions of the go-ur implementation. Its goal is to allow Gur to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gur releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gur release
  struct Version {
