...
#include "src/liburash/internal.c"
#include "src/liburash/sha3.c"
#include "src/liburash/io.c"

#ifdef _WIN32
#	include "src/liburash/io_win32.c"
#	include "src/liburash/mmap_win32.c"
#else
#	include "src/liburash/io_posix.c"
#endif

// 'gateway function' for calling back into go.
extern int urashGoCallback(unsigned);
int urashGoCallback_cgo(unsigned percent) { return urashGoCallback(percent); }
