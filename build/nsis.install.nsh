Name "gur ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ethereum/go-ur/issues"
!define UPDATEURL "https://github.com/ethereum/go-ur/releases"
!define ABOUTURL "https://github.com/ethereum/go-ur#ethereum-go"
...
# Install gur binary
Section "Gur" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gur}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gur.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gur.exe" "attach" "" ""
  ...
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gur.ipc"
