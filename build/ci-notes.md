...
people to build go-ur using the standard toolchain without any particular package
...
To allow reproducible builds of go-ur nonetheless that don't need network access
...
We want to build go-ur with the most recent version of Go, irrespective of the Go
...
Built packages are placed in the dist/ directory.
    ...
    $ cd ..
    $ dpkg-deb -c gur-unstable_1.5.0+xenial_amd64.deb
