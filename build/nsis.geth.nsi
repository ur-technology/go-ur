...
# 1. install gur for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gur
# 5. create gur, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since gur is installed global
