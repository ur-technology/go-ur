...
/*
Registrar implements the UR name registrar services mapping
- arbitrary strings to ur addresses
- hashes to hashes
...
// Registrar's backend is defined as an interface (implemented by xur, but could be remote)
