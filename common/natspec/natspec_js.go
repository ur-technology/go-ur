 ...
 * @param {String} type
 * @returns {Number} length of dynamic type, 0 or multiplication of URK_PADDING (32)
 */
var dynamicBytesLength = function (type) {
    if (isArrayType(type) || type === 'bytes')
        return c.URK_PADDING * 2;
    return 0;
};
...
/** @file formatters.js
 * @authors:
 *   Marek Kotewicz <marek@urdev.com>
 * @date 2015
 */
...
var formatInputInt = function (value) {
    var padding = c.URK_PADDING * 2;
    BigNumber.config(c.URK_BIGNUMBER_ROUNDING_MODE);
...
var formatInputString = function (value) {
    return utils.fromAscii(value, c.URK_PADDING).substr(2);
};
...
/// required to define URK_BIGNUMBER_ROUNDING_MODE
var BigNumber = require('bignumber.js');
...
module.exports = {
    URK_PADDING: 32,
    URK_SIGNATURE_LENGTH: 4,
    URK_UNITS: URK_UNITS,
    URK_BIGNUMBER_ROUNDING_MODE: { ROUNDING_MODE: BigNumber.ROUND_DOWN },
    URK_POLLING_TIMEOUT: 1000,
    URK_DEFAULTBLOCK: 'latest'
};
...
var unitMap = {
    ...
    'ur':    '1000000000000000000',
    'kur':   '1000000000000000000000',
    'grand':    '1000000000000000000000',
    'einstein': '1000000000000000000000',
    'mur':   '1000000000000000000000000',
    'gur':   '1000000000000000000000000000',
    'tur':   '1000000000000000000000000000000'
};
 ...
 * @param {String} unit the unit to convert to, default ur
 * @returns {BigNumber} value of the unit (in Wei)
 * @throws error if the unit is not correct:w
 */
var getValueOfUnit = function (unit) {
    unit = unit ? unit.toLowerCase() : 'ur';
...
/**
 * Takes a number of wei and converts it to any other ur unit.
 *
 * Possible units are:
 * - kwei/ada
 * - mwei/babbage
 ...
 * @param {String} unit the unit to convert from, default ur
 * @return {String|Object} When given a BigNumber object it returns one as well, otherwise a number
*/
    ...
    */
    ...
    function another(configObj) {
        var div,
            ...
            // Whur BigNumber Errors are ever thrown.
            ERRORS = true,                           // true or false

            // Change to intValidatorNoErrors if ERRORS is false.
            isValidInt = intValidatorWithErrors,     // intValidatorWithErrors/intValidatorNoErrors

            // Whur to use cryptographically-secure random number generation, if available.
                ...
                out: {
                    ...
                    r = rm < 4
                      ...
                      : rd > 5 || rd == 5 && ( rm == 4 || r || rm == 6 &&
                        ...
                        // Check whur the digit to the left of the rounding digit is odd.
         ...
         *
         * [z] {boolean|number} Whur to count integer-part trailing zeros: true, false, 1 or 0.
         */
