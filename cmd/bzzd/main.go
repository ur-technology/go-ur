...
import (
	...
	"github.com/ur-technology/go-ur/swarm"
	bzzapi "github.com/ur-technology/go-ur/swarm/api"
...
var (
	...
	EthAPI = cli.StringFlag{
		...
		Value: node.DefaultIPCEndpoint("gur"),
	}
)
...
func init() {
	// Override flag defaults so bzzd can run alongside gur.
