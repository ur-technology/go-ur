...
/**
 * This method should be used to combine solidity params togur
...
module.exports = function (str, isNew) {
    if (str.substr(0, 2) === '0x' && !isNew) {
        ...
        console.warn('see https://github.com/ur/web3.js/pull/205');
...
var unitMap = {
    ...
    'nano':         '1000000000',
    'szabo':        '1000000000000',
    'microur':   '1000000000000',
    'micro':        '1000000000000',
    'finney':       '1000000000000000',
    'milliur':    '1000000000000000',
 ...
 * - kwei       femtour     ada
 * - mwei       picour      babbage
 * - gwei       nanour      shannon      nano
 * - --         microur     szabo        micro
 * - --         milliur     finney       milli
 * - ur      --             --
 * - kur                    einstein     grand
 * - mur
 * - gur
...
/** @file web3.js
 * @authors:
 *   Jeffrey Wilcke <jeff@urdev.com>
 *   Marek Kotewicz <marek@urdev.com>
 *   Marian Oancea <marian@urdev.com>
 *   Fabian Vogelsteller <fabian@urdev.com>
 *   Gav Wood <g@urdev.com>
 * @date 2014
 */

var version = require('./version.json');
var net = require('./web3/methods/net');
var ur = require('./web3/methods/ur');
...
web3.ur.isSyncing = function (callback) {
    return new IsSyncing(callback);
};

/*jshint maxparams:4 */
web3.ur.filter = function (fil, callback) {
    return new Filter(fil, watches.ur(), formatters.outputLogFormatter, callback);
};
/*jshint maxparams:3 */
...
// ADD defaultblock
Object.defineProperty(web3.ur, 'defaultBlock', {
    get: function () {
...
Object.defineProperty(web3.ur, 'defaultAccount', {
    get: function () {
...
setupMethods(web3.ur, ur.methods);
setupProperties(web3.ur, ur.properties);
...
AllSolidityEvents.prototype.execute = function (options, callback) {
    ...
    return new Filter(o, watches.ur(), formatter, callback);
};
...
var checkForContractAddress = function(contract, abi, callback){
    ...
    // wait for receipt
    var filter = web3.ur.filter('latest', function(e){
        if(!e && !callbackFired) {
            count++;
            ...
            if(count > 50) {
                ...
                web3.ur.getTransactionReceipt(contract.transactionHash, function(e, receipt){
                    if(receipt && !callbackFired) {

                        web3.ur.getCode(receipt.contractAddress, function(e, code){
                            /*jshint maxcomplexity: 5 */
...
ContractFactory.prototype.new = function () {
    ...
    if(callback) {
        ...
        web3.ur.sendTransaction(options, function (err, hash) {
            if (err) {
                callback(err);
            } else {
        ...
        var hash = web3.ur.sendTransaction(options);
        // add the transaction hash
        contract.transactionHash = hash;
 ...
 * @return {Object} everything combined togur and encoded
 */
 ...
 * @file formatters.js
 * @author Marek Kotewicz <marek@urdev.com>
 * @author Fabian Vogelsteller <fabian@urdev.com>
 * @date 2015
 */
...
SolidityFunction.prototype.call = function () {
    ...
    if (!callback) {
        var output = web3.ur.call(payload, defaultBlock);
        return this.unpackOutput(output);
    }

    var self = this;
    web3.ur.call(payload, defaultBlock, function (error, output) {
...
SolidityFunction.prototype.sendTransaction = function () {
    ...
    if (!callback) {
        return web3.ur.sendTransaction(payload);
    }

    web3.ur.sendTransaction(payload, callback);
};
...
SolidityFunction.prototype.estimateGas = function () {
    ...
    if (!callback) {
        return web3.ur.estimateGas(payload);
    }

    web3.ur.estimateGas(payload, callback);
};
...
var HttpProvider = function (host) {
    this.host = host || 'http://localhost:9595';
};
...
/**
 * This method should be used to create iban object from ur address
 *
 * @method fromAddress
 * @param {String} address
...
Iban.createIndirect = function (options) {
    return Iban.fromBban('URK' + options.institution + options.identifier);
};
...
Iban.prototype.isValid = function () {
    return /^XE[0-9]{2}(URK[0-9A-Z]{13}|[0-9A-Z]{30,31})$/.test(this._iban) &&
...
/// @returns an array of objects describing web3.ur api methods
...
/// @returns an array of objects describing web3.ur api properties
...
/// @returns an array of objects describing web3.ur.filter api methods
var ur = function () {
 ...
 * @author Jeffrey Wilcke <jeff@urdev.com>
 * @author Marek Kotewicz <marek@urdev.com>
 * @author Marian Oancea <marian@urdev.com>
 * @author Fabian Vogelsteller <fabian@urdev.com>
 ...
 * It's also responsible for polling the ur node for incoming messages
...
RequestManager.prototype.poll = function () {
    /*jshint maxcomplexity: 6 */
    this.timeout = setTimeout(this.poll.bind(this), c.URK_POLLING_TIMEOUT);
...
var transferToAddress = function (from, to, value, callback) {
    return web3.ur.sendTransaction({
        address: to,
        from: from,
        value: value
    }, callback);
...
;(function (root, factory) {
	...
	var CryptoJS = CryptoJS || (function (Math, undefined) {
	    ...
	    var BufferedBlockAlgorithm = C_lib.BufferedBlockAlgorithm = Base.extend({
	         ...
	         *
	         * @param {boolean} doFlush Whur all blocks and partial blocks should be processed.
	         *
...
web3.ur.contract = require('./lib/web3/contract');
web3.ur.namereg = namereg.namereg;
web3.ur.ibanNamereg = namereg.ibanNamereg;
web3.ur.sendIBANTransaction = require('./lib/web3/transfer');
web3.ur.iban = require('./lib/web3/iban');
